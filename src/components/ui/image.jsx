...
// EXTENSION: a .webp output reencodes JPG/PNG uploads to WebP on the fly).
...
const ResponsiveImage = React.forwardRef(
  ({ parsed, fittingType, focalPoint, quality, className, style, aspectRatio, onLoad, ...props }, parentRef) => {
    ...
    // `size` is null exactly once: the premeasurement first render, which we
 ...
 * device pixel ratio) and reencoded to WebP; `fittingType="fill"` crops
